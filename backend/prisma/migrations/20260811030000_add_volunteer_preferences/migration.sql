...
-- Seed MVP support categories
INSERT INTO "support_categories" ("name", "description") VALUES
  ('Groceries', 'Grocery shopping and errands'),
  ('Errands', 'General errands and pickups'),
  ('Transport', 'Rides and transportation help'),
  ('Tech help', 'Technology and device assistance'),
  ('Companionship', 'Social visits and companionship'),
  ('Home help', 'Light home tasks and maintenance'),
  ('Other', 'Other types of support');
