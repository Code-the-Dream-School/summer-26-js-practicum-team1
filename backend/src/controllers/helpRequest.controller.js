...
const acceptHelpRequest = asyncHandler(
  async (req, res) => {
    const requestId = getRequestId(req);

    const helpRequest =
      await helpRequestService.acceptHelpRequest({
        requestId,
...
const declineHelpRequest = asyncHandler(
  async (req, res) => {
    const requestId = getRequestId(req);

    const response =
      await helpRequestService.declineHelpRequest({
        requestId,
        volunteerId: req.user.id,
      });
